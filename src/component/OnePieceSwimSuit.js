...
const  OnePieceSwimSuit = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            const neophyteProducts = data.filter(product => product.category === "Neophytegarment-SwimSuit");
    ...
    return (
        <div>
            <div className="mt-5" id="onepiece">
          <div className="custom-width-section">
            <p className="best-sellers fs-3">One Piece Swim Suit</p>
            <div className="row">
