...
const  MenSwimSuit = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            const neophyteProducts = data.filter(product => product.category === "Neophytegarment-menSwimSuit");
    ...
    return (
        <div>
            <div className="mt-5" id="menswimsuit">
          <div className="custom-width-section">
            <p className="best-sellers fs-3">Men Swim Suit</p>
            <div className="row">
