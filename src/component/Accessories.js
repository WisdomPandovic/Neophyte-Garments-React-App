...
const  Accessories = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const neophyteProducts = data.filter(product => product.category === "Neophytegarment-Accessories");
    ...
    return (
        <div>
            <div className="mt-5 " id="accessories">
          <div className="custom-width-section">
            <p className="best-sellers fs-3">Accessories</p>
            <div className="row">
